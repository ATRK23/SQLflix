...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(300, 300, 400, 500) #Taille initiale de la fenêtre
        self.setWindowIcon(QIcon("icone.png")) #Icone de la fenêtre ()
        ...
        self.pixmap = QPixmap("background.png") #Image de fond
...
class SignupWindow(QDialog):
    ...
    def register_user(self): #Fonction pour enregistrer un nouvel utilisateur
        ...
        try:
            ...
            query = "INSERT INTO users (username, password_hash) VALUES (%s, %s)" #On stocke le hash et non le mdp clair car trop peu sécurisé
